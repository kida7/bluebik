...
function calculate(t: SampleSize21Request) {
  return doCalculation(t);
}

function doCalculation(t: SampleSize21Request) {
  ...
  nb = Helper.roundUp(
    (1 + 1 / t.r) *
      Math.pow((t.sd * (z_alpha + z_beta)) / (t.pa - t.pb - ndelta), 2),
    0,
  );
  na = nb * t.r;
  n_total = na + nb;
