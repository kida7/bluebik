...
function calculate(t: SampleSize02Request) {
  return doCalculation(t);
}

function doCalculation(t: SampleSize02Request) {
  ...
  n_crude = (Math.pow(z, 2) * Math.pow(t.sd, 2)) / Math.pow(t.epsilon_a, 2);
  d = t.rho * (t.b - 1) + 1;
  ...
  result1 =
    ...
    t.conf * 100 +
    '% confident sample mean is within ' +
    t.epsilon_a +
